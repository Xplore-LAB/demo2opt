    ...
    stage_payload.update(
        {
            **stage_config,
            ...
            "material_balance_formula_name": data_payload.get("material_balance_formula_name") or "steady_load_material_balance",
            "material_balance_basis": data_payload.get("material_balance_basis") or "当前负荷基准、当前均值、前段均值与合理波动范围",
            "llm_trace": {
                "status": "stage_ready",
...
def nitrogen_agent_analyze():
    try:
        ...
        data_payload = {
            ...
            "material_balance_formula_status": "implemented",
            "material_balance_formula_name": "steady_load_material_balance",
            "material_balance_basis": load_baseline.get("basis") or "当前负荷基准、当前均值、前段均值与合理波动范围",
